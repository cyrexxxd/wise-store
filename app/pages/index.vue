...
<template>
  <section id="shop">
    <div class="sec-head">
      <h1>Каталог</h1>
      <p>
        Всё выдаётся на ник, указанный при оплате. Если вы не в сети — покупка придёт в течение
        нескольких минут после входа в игру. Шансы в кейсах — <NuxtLink class="text-link" to="/crates#odds">на странице кейсов</NuxtLink>.
      </p>
    </div>
